...
class SceneExtractor:
    ...
    async def get_next_scene(
        ...
        messages = [
            SystemMessage(content=system_prompt_template_get_next_scene.format(format_instruction=parser.get_format_instructions())),
            HumanMessage(content=human_prompt_template_get_next_scene)
        ]
