...
class ReferenceImageSelector:
    ...
    async def select_reference_images_and_generate_prompts(
            self,
        ...
        if len(available_image_path_and_text_pairs) >= 8:
            ...
            try:
                ...
                filtered_image_path_and_text_pairs = [available_image_path_and_text_pairs[i] for i in
                                                      ref.ref_image_indices]
            ...
            parser = PydanticOutputParser(pydantic_onject=RefImageIndicesAndTextPrompt)
            ...
            try:
                ...
                reference_image_path_and_text_pairs = [filtered_image_path_and_text_pairs[i] for i in
                                                       response.ref_image_indices]
                return {
